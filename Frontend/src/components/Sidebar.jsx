...
const Sidebar = () => {
    ...
    return (
        <aside className="h-full w-full mobile:w-72 border-r border-base-300 flex flex-col transition-all duration-200">
            <div className="border-b border-base-300 w-full p-5">
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                        <Users className="size-6" />
                        <span className="font-medium hidden mobile:block">Chats</span>
                    </div>
                    <button
                ...
                <div className="hidden mobile:flex mt-3">
                    <button
            ...
            <div className="overflow-y-auto w-full py-3">
                {/* For small screens (combined list with details) */}
                ...
                {/* For large screens (tabbed list with details) */}
                ...
                {/* No results message */}
                {((activeTab === 'users' && filteredUsers.length === 0) || (activeTab === 'groups' && filteredGroups.length === 0)) && searchTerm && (
